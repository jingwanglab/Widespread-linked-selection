...
bam_list_tremula="/proj/b2011141/nobackup/PaperIV-phylogenomics/bam/tremula/tremula.bam.list"
ref="/proj/b2011141/nobackup/reference/nisqV3/Ptrichocarpa_v3.0_210.fa"
OutDir="/proj/b2011141/nobackup/PaperIV-phylogenomics/ANGSD/tremula/tremula_$1"
...
$thetaStat do_stat $OutDir/tremula_$1.thetas.gz -nChr $nChrom -win 100000 -step 100000 -outnames $OutDir/tremula_$1.thetas100000.window.gz
$thetaStat do_stat $OutDir/tremula_$1.thetas.gz -nChr $nChrom -win 10000 -step 10000 -outnames $OutDir/tremula_$1.thetas10000.window.gz
$thetaStat do_stat $OutDir/tremula_$1.thetas.gz -nChr $nChrom -win 50000 -step 50000 -outnames $OutDir/tremula_$1.thetas50000.window.gz
...
Rscript $thetas_r tremula $1 100000 100000
Rscript $thetas_r tremula $1 10000 10000
Rscript $thetas_r tremula $1 50000 50000

#####Summarize all chromsome-level output files to a single file

OutDir_new="/proj/b2011141/nobackup/PaperIV-phylogenomics/ANGSD/tremula"
for chr in {02..19}
do
sed '1d' $OutDir_new/tremula_$chr/tremula_$chr.10000bp10000bp.thetas.txt > $OutDir_new/tremula_all/tremula_$chr.10000bp10000bp.thetas.txt
done
cp $OutDir_new/tremula_01/tremula_01.10000bp10000bp.thetas.txt  $OutDir_new/tremula_all/tremula_01.10000bp10000bp.thetas.txt

input=
for chr in {01..19}
do
input="$input $OutDir_new/tremula_all/tremula_$chr.10000bp10000bp.thetas.txt"
done
cat $input > $OutDir_new/tremula_all/tremula_all.10000bp10000bp.thetas.txt && rm $input
